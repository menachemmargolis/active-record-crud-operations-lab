...
def can_be_instantiated_and_then_saved
  madigascar = Movie.new
  madigascar.title = "This is a title."
  madigascar.save
end
...
def can_be_created_with_a_hash_of_attributes
  ...
  movie2 =Movie.create(attributes)
end
...
def can_update_using_update_method
  ...
  jj = Movie.create(title: "Wat?")
  jj.update(title:"Wat, huh?")
...
def can_destroy_a_single_item
  ...
  movie.update(title: "hello world")}
end
